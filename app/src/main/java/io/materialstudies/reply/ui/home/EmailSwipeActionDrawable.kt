...
import io.materialstudies.reply.util.lerpArgb
...
class EmailSwipeActionDrawable(context: Context) : Drawable() {
    ...
    private val circlePaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = context.themeColor(colorSecondary)
    ...
    @ColorInt
    private val iconTint = context.themeColor(colorOnBackground)
    @ColorInt
    private val iconTintActive = context.themeColor(colorOnSecondary)

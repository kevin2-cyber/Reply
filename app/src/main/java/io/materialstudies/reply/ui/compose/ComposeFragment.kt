...
class ComposeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentComposeBinding.inflate(
            inflater,
            container,
            false
        )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.run {
            ...
            composeEmail.nonUserAccountRecipients.forEach {
                addRecipientChip(it)
            }
            ...
            senderSpinner.adapter = ArrayAdapter(
                ...
                AccountStore.getAllUserAccounts().map {
                    it.email
                }
            )
    ...
    private fun expandChip(chip: View) {
        ...
        binding.run {
            recipientCardView.setOnClickListener {
                collapseChip(chip)
            }
            recipientCardScrim.visibility = View.VISIBLE
            recipientCardScrim.setOnClickListener {
                collapseChip(chip)
            }
        }
